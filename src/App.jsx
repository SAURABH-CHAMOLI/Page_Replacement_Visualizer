...
// import PagingTheory from './pages/PagingTheory';
// import FIFOPage from './pages/FIFOPage';
// import LRUPage from './pages/LRUPage';
// import MRUPage from './pages/MRUPage';
...
//             <Route path="/paging-theory" element={<PagingTheory />} />
//             <Route path="/fifo" element={<FIFOPage />} />
//             <Route path="/lru" element={<LRUPage />} />
//             <Route path="/mru" element={<MRUPage />} />
//             <Route path="/optimal" element={<OptimalPage />} />
//             <Route path="*" element={<Navigate to="/" />} />
//           </Routes>
//         </main>
//         <footer className="footer">
//           <p>Page Replacement Algorithms Simulator © 2025</p>
//         </footer>
//       </div>
//     </Router>
//   );
